...
export default class ABCBinding {
    private static instance: ABCBinding;

    public static get Instance() {
        if (!this.instance) {
            this.instance = new ABCBinding();
        }
        return this.instance;
    }

    public static withOptions(options: Options): ABCBinding {
     ...
     */
    public withOptions(options: Options): ABCBinding {
    ...
    public callNativeMethod(methodName: string, args?: Record<string, string | number | boolean>): Promise<any> {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (hasCallback || hasProgress) {
                ...
                cbName = `ABC_CB${new Date().getTime()}_${AUTO_INCREASE_ID++}`;
            ...
            if (cc.sys.isNative && cc.sys.os === cc.sys.OS_ANDROID) {
                const resultCode = jsb.reflection.callStaticMethod('com/tencent/abckit/binding/ABCBinding', 'execute', '(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I',
                ...
                const retId = jsb.reflection.callStaticMethod('ABCBinding', 'executeWithMethodName:args:callback:',
                    methodName, typeof args === 'object' ? JSON.stringify(args) : '', cbName);
            } else {
