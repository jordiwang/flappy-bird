...
export default class ABCLog {

    private static instance: ABCLog;
    private static TAG = 'ABCLog';

    public static get Instance() {
        if (!this.instance) {
            this.instance = new ABCLog();
        }
...
const abclog = ABCLog.Instance;
cc.log = abclog.i.bind(abclog);
cc.warn = abclog.w.bind(abclog);
cc.error = abclog.e.bind(abclog);
